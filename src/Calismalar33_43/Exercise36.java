...
public class Exercise36 {
    /*
    Yer səthində iki nöqtə arasındakı məsafəni hesablamaq üçün Java proqramı yazın. Redaktora gedin
İki nöqtə arasındakı məsafə [ (x1,y1) & (x2,y2)]
d = radius * arccos(sin(x1) * sin(x2) + cos(x1) * cos(x2) * cos(y1 - y2))
Yerin radiusu r = 6371.01 Kilometr
     */
