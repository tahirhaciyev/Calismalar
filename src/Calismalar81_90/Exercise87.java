...
public class Exercise87 {
    /*
    Tam ədədi oxumaqdansa Java proqramı yazın
    və onun rəqəmlərinin cəmini hesablayın və cəminin hər rəqəminin nömrəsini ingilis dilində yazın.
     */
    public static <IOExceptione> void main(String[] args) {
